...
class TransactionRepository {
  ...
  /// Guarda los cambios de un movimiento ya existente. El trigger de la base
  /// se encarga de marcarlo como pendiente para que suba al servidor.
  Future<void> actualizarTransaccion(TransactionEntity tx) async {
    await (_db.update(_db.transactions)..where((t) => t.id.equals(tx.id)))
        .write(_toCompanion(tx));
  }

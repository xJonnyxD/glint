            ...
            sliver: SliverList.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Aparecer(indice: index, child: _DeudaCard(deuda: deuda)),
                );
              },
            ),
          ),
  ...
  Widget _buildEstadoVacio(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Icon(
            _tabSeleccionada == 0 ? AppIcons.expense : AppIcons.income,
            size: 56,
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(
                        esLeDebo ? AppIcons.expense : AppIcons.income,
                        size: 24,
                        color: color,
                      ),
                    ),

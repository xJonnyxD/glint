        ...
        if (state.transacciones.isEmpty)
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
              (ctx, i) => Aparecer(
                indice: i,
                child: _TransaccionCard(transaccion: state.transacciones[i]),
              ),
        ...
        children: [
          Row(
            children: [
              ...
              // Tapa el saldo de un toque, para no enseñarlo a quien pase al
              // lado. La preferencia se recuerda por usuario.
          ...
          ValueListenableBuilder<bool>(
            ...
            builder: (context, _, _) => Text(
              PrivacidadSaldo.instancia
                  .formatear('\$${state.balance.toStringAsFixed(2)}'),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              // También se tapan: ocultar el balance y dejar a la vista
              // ingresos y gastos no ocultaría gran cosa.
              ValueListenableBuilder<bool>(
                valueListenable: PrivacidadSaldo.instancia,
                builder: (context, _, _) => Text(
                  PrivacidadSaldo.instancia
                      .formatear('\$${monto.toStringAsFixed(2)}'),
                  style: TextStyle(
                      color: onPrimary,
                      fontWeight: FontWeight.w700,
                      fontSize: 14),
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Icon(
                        iconoDeCategoriaEmoji(transaccion.categoriaEmoji),
                        size: 24,
                        color: esIngreso
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(iconoDeCategoriaEmoji(transaccion.categoriaEmoji), size: 32),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: AnimatedContainer(
        ...
        child: Center(
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(icono, size: 18, color: selected ? Colors.white : null),
              const SizedBox(width: 6),
              Text(
                label,
                style: TextStyle(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Análisis financiero con gráficos y export PDF.
          Card(
          ...
          const SizedBox(height: 10),
          // Acceso a la sección social de gastos compartidos (estilo Settle Up).
          Card(
            clipBehavior: Clip.antiAlias,
            child: ListTile(
              leading: Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: const Color(0xFF6750A4).withAlpha(38),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: const Center(
...
class _HerramientaCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // El color base es una variante clara fija; sobre fondo oscuro el texto/
    // icono quedaban de bajo contraste. Se tiñe la tarjeta y se calcula un
    // color de primer plano legible sobre ese fondo real.
    final fondo = Color.alphaBlend(
      color.withValues(alpha: oscuro ? 0.22 : 0.12),
      tema.colorScheme.surface,
    );
    final acento = AppColors.legibleSobre(color, fondo);
    return GestureDetector(
      onTap: onTap,
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: acento, size: 26),
            const SizedBox(height: 6),
            Text(
              label,
              style: TextStyle(

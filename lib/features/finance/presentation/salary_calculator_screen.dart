...
class _TarjetaInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Symbols.lightbulb_rounded, size: 28),
          ...
          Row(
            ...
            children: [
              ...
              _ResumenItem(
                ...
                icono: Symbols.bar_chart_rounded,
              ),
            ],
          ),
        ],
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                const Icon(Symbols.receipt_long_rounded, size: 20),
          ...
          _FilaDeduccion(
            icono: Symbols.local_hospital_rounded,
            titulo: 'ISSS',
            subtitulo:
          ...
          _FilaDeduccion(
            icono: Symbols.account_balance_rounded,
            titulo: 'ISR (Renta)',
            subtitulo:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Symbols.bar_chart_rounded, size: 20),
              const SizedBox(width: 8),
              Text(

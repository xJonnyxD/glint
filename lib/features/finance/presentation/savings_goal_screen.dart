...
// Metas: se guarda el emoji (campo sincronizado), pero se pinta como icono.
const _emojisDisponibles = [
  '🏠', '✈️', '🚗', '💻', '📱', '🏋️', '🎓', '💍', '🌴', '🎮',
  '🎸', '📷', '🐕', '⛵', '🏖️', '🎨', '🍕', '💊', '📚', '🚀',
];

const Map<String, IconData> _iconoMetaMap = {
...
IconData iconoMeta(String emoji) =>
    _iconoMetaMap[emoji] ?? Symbols.savings_rounded;
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(iconoMeta(meta.emoji), size: 28, color: color),
                    ),
                  ),

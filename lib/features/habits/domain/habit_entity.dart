...
/// `icono` es una CLAVE del catálogo de HabitIcons (no un emoji).
const List<Map<String, dynamic>> habitosSugeridos = [
  {'nombre': 'Ejercicio',          'icono': 'run',      'categoria': CategoriaHabito.salud},
  {'nombre': 'Meditación',         'icono': 'meditate', 'categoria': CategoriaHabito.mente},
  {'nombre': 'Leer 30 min',        'icono': 'read',     'categoria': CategoriaHabito.productividad},
  {'nombre': 'Tomar agua',         'icono': 'water',    'categoria': CategoriaHabito.salud},
  {'nombre': 'Comer sano',         'icono': 'eat',      'categoria': CategoriaHabito.nutricion},
  {'nombre': 'Journaling',         'icono': 'write',    'categoria': CategoriaHabito.mente},
  {'nombre': 'Sin redes sociales', 'icono': 'phone',    'categoria': CategoriaHabito.productividad},
  {'nombre': 'Dormir 8h',          'icono': 'sleep',    'categoria': CategoriaHabito.salud},
  {'nombre': 'Vitaminas',          'icono': 'medicine', 'categoria': CategoriaHabito.salud},
  {'nombre': 'Ahorro diario',      'icono': 'money',    'categoria': CategoriaHabito.finanzas},
  {'nombre': 'Llamar a familia',   'icono': 'phone',    'categoria': CategoriaHabito.social},
  {'nombre': 'Ducha fría',         'icono': 'water',    'categoria': CategoriaHabito.salud},
];

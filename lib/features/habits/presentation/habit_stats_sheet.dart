        ...
        Row(
          children: [
            _StatCard(
              label: 'Días activos',
              valor: '$totalDias',
              icono: Symbols.calendar_month_rounded,
            ),
            const SizedBox(width: 12),
            _StatCard(
              label: 'Mejor día',
              valor: '$mejorDia hábitos',
              icono: Symbols.military_tech_rounded,
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(
          children: [
            _StatCard(label: 'Total completados', valor: '$totalCompletados', icono: Symbols.check_circle_rounded),
            const SizedBox(width: 12),
            _StatCard(label: 'Mejor racha', valor: '$mejorRacha días', icono: Symbols.local_fire_department_rounded),
          ],
        ),
        const SizedBox(height: 12),
        Row(
          children: [
            _StatCard(label: 'Racha actual', valor: '$rachaActual días', icono: Symbols.bolt_rounded),
            const SizedBox(width: 12),
            _StatCard(label: 'Hábitos activos', valor: '${habitos.length}', icono: Symbols.target_rounded),
          ],
        ),
          ...
          return Card(
            ...
            child: ListTile(
              leading: CircleAvatar(
                ...
                child: Icon(
                  desbloqueado ? logro.icono : AppIcons.lock,
                  size: 22,
                  color: desbloqueado ? logro.color : null,
                ),
              ),
              title: Text(
                logro.titulo,
...
class _HabitoRankRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        dense: true,
        leading: Icon(HabitIcons.iconoDeClave(habito.icono), size: 24),
        title: Text(habito.nombre,
            style: const TextStyle(fontWeight: FontWeight.w600)),
        trailing: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(AppIcons.trophy, size: 15, color: colorScheme.tertiary),

...
extension CategoriaNotaX on CategoriaNote {
  ...
  /// Ícono vectorial de la categoría (reemplaza al emoji en la UI).
  IconData get icono {
    switch (this) {
      case CategoriaNote.personal: return Symbols.person_rounded;
      case CategoriaNote.trabajo:  return Symbols.work_rounded;
      case CategoriaNote.ideas:    return Symbols.lightbulb_rounded;
      case CategoriaNote.recetas:  return Symbols.skillet_rounded;
      case CategoriaNote.compras:  return Symbols.shopping_cart_rounded;
      case CategoriaNote.salud:    return Symbols.favorite_rounded;
      case CategoriaNote.otro:     return Symbols.description_rounded;
    }
  }
}
